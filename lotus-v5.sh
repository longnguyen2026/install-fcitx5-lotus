...
# Lotus Installer v7 Universal - Clean Fcitx5
# Fixes fcitx5-lotus 3.5.6-1 broken Debian postinst on Ubuntu/Kubuntu/Zorin.

BLUE='\033[1;34m'; GREEN='\033[1;32m'; YELLOW='\033[1;33m'; RED='\033[1;31m'; NC='\033[0m'

printf '%b\n' "${BLUE}======================================="
printf '%b\n' "     Lotus Installer v7 Universal - Clean Fcitx5"
printf '%b\n' "     Ubuntu / Kubuntu / Zorin / Debian"
printf '%b\n' "     X11 + Wayland"
printf '%b\n' "=======================================${NC}"
...
case "$OS_ID" in
  ubuntu|kubuntu|linuxmint|zorin) FAMILY=ubuntu ;;
  debian) FAMILY=debian ;;
  *)
    if printf '%s' "$OS_LIKE" | grep -qi debian; then FAMILY=debian; else
      printf '%b\n' "${RED}Unsupported OS: ${PRETTY_NAME}${NC}"; exit 1
    fi
    ;;
esac
